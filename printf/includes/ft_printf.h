...
/*   Updated: 2019/04/29 21:43:52 by asipes           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
long long int				pr_max_val(t_tab *a, long long int num);
void						hex_chec_len(t_tab *a);
void						hex_check_fl(t_tab *a);
void						check_sig(t_tab *a, long long int num);
void						zero_val(t_tab *a);
